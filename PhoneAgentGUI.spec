...
a = Analysis(
    ...
    pathex=[],
    binaries=[],
    datas=[('adb.exe', '.'), ('hdc.exe', '.'), ('AdbWinApi.dll', '.'), ('AdbWinUsbApi.dll', '.'), ('libwinpthread-1.dll', '.'), ('libusb_shared.dll', '.'), ('ADBKeyboard.apk', '.'), ('phone_agent', 'phone_agent'), ('main.py', '.'), ('ios.py', '.'), ('ai_config.json', '.'), ('gui_config.json', '.'), ('gzh.png', '.'), ('demo_integration.py', '.'), ('task_simplifier.py', '.'), ('WebDriverAgent', 'WebDriverAgent')],
